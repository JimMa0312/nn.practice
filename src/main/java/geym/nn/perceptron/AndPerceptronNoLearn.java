...
public class AndPerceptronNoLearn extends NeuralNetwork {
    ...
    /**
     * AndPereptronNoLearn构造函数
     * @param inputNeuronsCount 输入参数数量
     */
    ...
    private void createNetWork(int inputNeuronsCount){
        ...
        //设置输入神经元和感知机之间的连接权重
        List<Connection> inputConnections = n.getInputConnections();
        inputConnections.get(0).getWeight().setValue(1);
        inputConnections.get(1).getWeight().setValue(1);
        inputConnections.get(2).getWeight().setValue(-1.5);
    }
